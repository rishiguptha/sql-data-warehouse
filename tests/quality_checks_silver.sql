...
SELECT '>> [1/6] Completed quality checks for: silver.crm_cust_info' AS progress;


-- ============================================================
-- Quality Checks: silver.crm_prd_info
-- ============================================================
SELECT '>> [2/6] Starting quality checks for: silver.crm_prd_info' AS progress;
...
SELECT '>> [2/6] Completed quality checks for: silver.crm_prd_info' AS progress;


-- ============================================================
-- Quality Checks: silver.crm_sales_details
-- ============================================================
SELECT '>> [3/6] Starting quality checks for: silver.crm_sales_details' AS progress;
...
SELECT '   [3/6 | Check 4] NULL date values (sls_order_dt)' AS progress;
SELECT sls_order_dt
FROM silver.crm_sales_details
...
SELECT '>> [3/6] Completed quality checks for: silver.crm_sales_details' AS progress;


-- ============================================================
-- Quality Checks: silver.erp_cust_az12
-- ============================================================
SELECT '>> [4/6] Starting quality checks for: silver.erp_cust_az12' AS progress;
...
SELECT '>> [4/6] Completed quality checks for: silver.erp_cust_az12' AS progress;


-- ============================================================
-- Quality Checks: silver.erp_loc_a101
-- ============================================================
SELECT '>> [5/6] Starting quality checks for: silver.erp_loc_a101' AS progress;
...
SELECT '>> [5/6] Completed quality checks for: silver.erp_loc_a101' AS progress;


-- ============================================================
-- Quality Checks: silver.erp_px_cat_g1v2
-- ============================================================
SELECT '>> [6/6] Starting quality checks for: silver.erp_px_cat_g1v2' AS progress;
...
SELECT '>> [6/6] Completed quality checks for: silver.erp_px_cat_g1v2' AS progress;
SELECT '>> All silver layer quality checks complete.' AS progress;